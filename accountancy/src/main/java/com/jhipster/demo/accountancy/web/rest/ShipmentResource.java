...
import com.jhipster.demo.accountancy.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.jhipster.demo.accountancy.domain.Shipment}.
 */
@RestController
@RequestMapping("/api")

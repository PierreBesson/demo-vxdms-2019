...
class InvoiceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Invoice entity")
        ...
        .repeat(2) {
            ...
            .get("/services/accountancy/api/invoices")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new invoice")
            .post("/services/accountancy/api/invoices")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "code":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/accountancy${new_invoice_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created invoice")
            .delete("/services/accountancy${new_invoice_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
